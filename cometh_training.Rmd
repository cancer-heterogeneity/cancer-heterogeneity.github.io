...
- [Breast cancer - brca](data/selected-BRCA.htseq_fpkm.csv)
- [Glioblastome - gbm](data/selected-GBM.htseq_fpkm.csv)
- [Lund adenocarcinoma - luad](data/selected-LUAD.htseq_fpkm.csv)
- [Pancreatic adenocarcinoma - paad](data/selected-PAAD.htseq_fpkm.csv)
- [Skin cutaneous melanoma - skcm](data/selected-SKCM.htseq_fpkm.csv)
