...
Deconbench is available on Codalab [here]( https://competitions.codalab.org/competitions/23660?secret_key=d3af365e-44f5-41e5-9d6c-bd44dec321fa). 
...
(c) Raw cell type profile matrices were preprocessed (Normalization, signal transformation, sample aggregation) to avoid any batch effect. 
...
(e) Paired methylome and transcriptome of in silico mixtures from pancreatic tumors were obtained by considering D = T A, with T the cell-type profiles (5 cell types, M features) and A the cell-type proportion per patient (30 patients, 5 cell types) common between both omics.  
